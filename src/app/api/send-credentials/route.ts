...
from: 'Admin <admin@jyotinepal.com>',
to: [email],
...
<h1 style="color: #ffffff; margin: 0; font-size: 28px;">Welcome to Jyotinepal admin panel!</h1>
</td>
</tr>
...
<li>Visit our login page at <a href="https://admin.jyotinepal.com" style="color: #CE9F41;">admin.jyotinepal.com</a></li>
<li>Use the credentials provided above</li>
<li>Navigate to top right, you will see the user icon, click on it and choose "Change Password"</li>
<li>Start exploring the platform</li>
</ol>

<p style="color: #333333; font-size: 14px; line-height: 1.6; margin: 0;">
If you have any questions or need assistance, feel free to contact our support team at <a href="mailto:jyoti4nepal@gmail.com" style="color: #CE9F41;">jyoti4nepal@gmail.com</a>.
</p>
</td>
</tr>
...
© ${new Date().getFullYear()} jyotinepal.com. All rights reserved.
</p>
</td>
</tr>
